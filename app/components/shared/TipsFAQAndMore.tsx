...
export default function TipsFAQAndMore() {
  ...
  return (
    <div className="w-full px-6 space-y-10 py-10 mt-20"
      style={{
        background: "radial-gradient(at 40% 88%, #000000 0px, transparent 50%), radial-gradient(at 40% 14%, #000000 0px, transparent 50%), radial-gradient(at -111% 60.04166634877523%, #84dfff 0px, transparent 60%), radial-gradient(at 180.0301722493665% 30%, #516beb 0px, transparent 50%), #000"
      }}
    >
      <div className=" text-white max-w-6xl mx-auto">
        {/* 💡 TIPS & TRICKS */}
        <div className="border-y border-white/10 py-8">
          <div className="flex items-center gap-1 bg-blue-500  w-fit  font-bold">
          ...
          <div className="grid md:grid-cols-2 gap-10 mt-6 ">
            ...
            {/* Sharing Tips */}
            <div>
              <h3 className="font-semibold mb-3 ">Sharing Suggestions</h3>
              <ul className="space-y-2 list-disc list-inside ">
        ...
        {/* ⭐ HOW IT WORKS */}
        <div className="border-y border-white/10 py-8">
          <h2 className="flex items-center gap-1 bg-blue-500  w-fit  font-bold">
            <FaMagic className="" />
            How It Works
          </h2>
          ...
          <div className="grid sm:grid-cols-3 gap-8  mt-6">
            ...
            <div className="space-y-2 flex justify-center items-center gap-8">
              <div>
                <h3 className="font-semibold mb-1 ">1. Enter Your Information</h3>
                <p className=" text-sm">
            ...
            <div className="space-y-2 flex justify-center items-center gap-8">
              <div>
                <h3 className="font-semibold mb-1 ">2. Style Your Card</h3>
                <p className=" text-sm">
            ...
            <div className="space-y-2 flex justify-center items-center gap-8">
              <div>
                <h3 className="font-semibold mb-1 ">3. Generate & Download</h3>
                <p className=" text-sm">
          ...
          <div className="text-sm mt-6 space-y-4 ">
            ...
            {faq.map((item, index) => (
              <div key={index} className="border-b border-white/10 pb-3 ">
                ...
                {openIndex === index && (
                  <p className="mt-3  transition transform duration-300 ease-in-out translate-x-1.5">
                    {item.a}
                  </p>
                )}
              </div>
