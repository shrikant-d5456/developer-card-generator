...
export default function Footer() {
  return (
    <footer className="relative w-full bg-[#0a0a0a] text-white"
       style={{
      background: "radial-gradient(at 40% 88%, #000000 0px, transparent 50%), radial-gradient(at 40% 14%, #000000 0px, transparent 50%), radial-gradient(at 30% 80.04166634877523%, #516beb  0px, transparent 60%), radial-gradient(at 94.0301722493665% 111%, #516beb  0px, transparent 50%), #000"
    }}
    >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="">
            ...
            <div className=" flex flex-col gap-3 w-[300px]">
              <p className="text-white font-bold">✨ Special Thanks,</p>
              <hr className="border-white/10" />
              <ul className=" flex flex-col gap-2">
                <li className=" text-sm list-none  ">Simpli Ui</li>
                <li className=" text-sm list-none ">NextStep</li>
                <li className=" text-sm list-none ">Sonner toastify</li>
                <li className=" text-sm list-none ">Chatgpt</li>
              </ul>
            </div>
          </div>
